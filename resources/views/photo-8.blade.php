...
<div class="wrap main-wrap">
    ...
    <div class="products-items-grid">
        <div class="product_col products-items-grid_col">
            <div class="product_img"><img src="../img/products-work/19.jpg" class="work-img expand-img" data-full="../img/products-work/full/19.jpg"></div>


        </div>
        <div class="product_col products-items-grid_col">
            <div class="product_img"><img src="../img/products-work/18.jpg" class="work-img expand-img" data-full="../img/products-work/full/18.jpg"></div>
