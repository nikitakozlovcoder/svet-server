    ...
    <div class="desc">
        <div class="desc_block desc_slider">
            <div class="desc_slider_wrap result_desc" style="cursor: crosshair; position: relative; background-repeat: no-repeat;">
                ...
                <img src="../img/products/29.jpg" alt="" class="desc_slider_img desc_show_img" style="transition: opacity 0.4s linear">
            </div>
            <div class="desc_preview">
                <div class="desc_preview_image_wrap" style="background-image: url('../img/products/29.jpg'); cursor: pointer; border-color: #00bfd3;" data-href="../img/products/29.jpg"></div>

                <div class="desc_preview_image_wrap" style="background-image: url('../img/products/30.jpg'); cursor: pointer;" data-href="../img/products/30.jpg"></div>
                <div class="desc_preview_image_wrap" style="background-image: url('../img/products/31.jpg'); cursor: pointer;" data-href="../img/products/31.jpg"></div>
        ...
        <div class="desc_block desc_text">
            <div class="product_text">
                <h1>INDUSTRY <span style="color: #00bfd3">150</span></h1>
                <h3>Технические характеристики.</h3>
                <div>
                    Мощность Вт - <span>150</span>;
                </div>
                <div>
                    Кол-во светодиодов - <span>144</span>;
                </div>
                <div>
                ...
                <div>
                    Световой поток - <span>21 168лм</span>;
                </div>
                <div>
