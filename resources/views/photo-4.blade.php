...
<div class="wrap main-wrap">
    <div class="section_title">
        ...
        <div class="section_title_text">Освещение улиц Победы и Магистральной.</div>
    </div>
    <div class="products-items-grid">
        <div class="product_col products-items-grid_col">
            <div class="product_img"><img src="../img/products-work/AM/10.jpg" class="work-img expand-img" data-full="../img/products-work/AM/full/10.jpg"></div>

        </div>
        <div class="product_col products-items-grid_col">
            <div class="product_img"><img src="../img/products-work/AM/11.jpg" class="work-img expand-img" data-full="../img/products-work/AM/full/11.jpg"></div>

        </div>
        <div class="product_col products-items-grid_col">
            <div class="product_img"><img src="../img/products-work/AM/12.jpg" class="work-img expand-img" data-full="../img/products-work/AM/full/12.jpg"></div>

        </div>
        <div class="product_col products-items-grid_col">
            <div class="product_img"><img src="../img/products-work/AM/13.jpg" class="work-img expand-img" data-full="../img/products-work/AM/full/13.jpg"></div>

        </div>
        <div class="product_col products-items-grid_col">
            <div class="product_img"><img src="../img/products-work/AM/14.jpg" class="work-img expand-img" data-full="../img/products-work/AM/full/14.jpg"></div>

        </div>
        <div class="product_col products-items-grid_col">
            <div class="product_img"><img src="../img/products-work/AM/15.jpg" class="work-img expand-img" data-full="../img/products-work/AM/full/15.jpg"></div>
        </div>
    </div>
