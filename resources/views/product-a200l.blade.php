...
<header>
    <nav class="nav" style="background: white !important">
        <div class="wrap">
            ...
            <div class="logo" style="color: #515562 !important;display: flex;"><div><a href='/products'><i class="fa fa-arrow-left" style="font-size:16px; padding-right: 25px;" ></i></a>	</div>	<span>SVE</span>T-SKG</div>
            <div class="toggle">
	...
	<a href='/products'>
        ...
        <div class="desc">
			...
			<div class="desc_slider_wrap result_desc" style="cursor: crosshair; position: relative; background-repeat: no-repeat;">
                    ...
                    <img src="../img/products/25.jpg" alt="" class="desc_slider_img desc_show_img" style="transition: opacity 0.4s linear">
                </div>
                <div class="desc_preview">
                    <div class="desc_preview_image_wrap" style="background-image: url('../img/products/25.jpg'); cursor: pointer; border-color: #00bfd3;" data-href="../img/products/25.jpg"></div>
				
                    <div class="desc_preview_image_wrap" style="background-image: url('../img/products/26.jpg'); cursor: pointer;" data-href="../img/products/26.jpg"></div>
                    <div class="desc_preview_image_wrap" style="background-image: url('../img/products/27.jpg'); cursor: pointer;" data-href="../img/products/27.jpg"></div>
                    <div class="desc_preview_image_wrap" style="background-image: url('../img/products/28.jpg'); cursor: pointer;" data-href="../img/products/28.jpg"></div>
                  
                </div>
            </div>
            <div class="desc_block desc_text">
                <div class="product_text">
                    <h1>AVENUE <span style="color: #00bfd3">K-200L</span></h1>
                ...
                <div>
                    Длина – <span>___мм</span>;
                </div>
                <div>
                    Ширина – <span>___мм</span>;
                </div>
                <div>
                ...
                <div class="wrap contact_cols">
                    <div class="contact_col ">
                        ...
                        <div class="contact_tel contact_elem"><i class="fas fa-phone"></i>
                            <div class="contact_elem_text">+7(951)513-33-01</div>
                        </div>
                        <div class="contact_mail contact_elem"><i class="far fa-envelope"></i>
                            <div class="contact_elem_text">ooo-skg@mail.ru</div>
                        </div>
                    </div>
                    <div class="contact_col">
...
<footer style="margin-top: auto">
    ...
    <div class="wrap footer">
        ...
        <div style="order: 3;">Разработано командой <a href="https://nek-web.ru" style="color: #00bfd3; ">NekWeb</a>.</div>
    </div>
</footer>
