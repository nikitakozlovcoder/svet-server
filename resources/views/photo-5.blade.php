...
<div class="wrap main-wrap">
    ...
    <div class="products-items-grid">
        <div class="product_col products-items-grid_col">
            <div class="product_img"><img src="../img/products-work/14.jpg" class="work-img expand-img" data-full="../img/products-work/full/14.jpg"></div>

        </div>
        <div class="product_col products-items-grid_col">
            <div class="product_img"><img src="../img/products-work/15.jpg" class="work-img expand-img" data-full="../img/products-work/full/15.jpg"></div>

        </div>
        <div class="product_col products-items-grid_col">
            <div class="product_img"><img src="../img/products-work/16.jpg" class="work-img expand-img" data-full="../img/products-work/full/16.jpg"></div>

        </div>
        <div class="product_col products-items-grid_col">
            <div class="product_img"><img src="../img/products-work/17.jpg" class="work-img expand-img" data-full="../img/products-work/full/17.jpg"></div>
