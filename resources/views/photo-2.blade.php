...
<div class="wrap main-wrap">
    <div class="section_title">
        <h2>Светильник 50 Ватт у частного дома.</h2>
    ...
    <div class="products-items-grid">
        <div class="product_col products-items-grid_col">
            <div class="product_img"><img src="../img/products-work/8.jpg" class="work-img expand-img" data-full="../img/products-work/full/8.jpg"></div>

        </div>
        <div class="product_col products-items-grid_col">
            <div class="product_img"><img src="../img/products-work/10.jpg" class="work-img expand-img" data-full="../img/products-work/full/10.jpg"></div>
